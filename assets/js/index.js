...
document.getElementById('botaoFormulario').onclick = function calcularTudo(){
    ...
    if (peca1.espessura == 1.25){
        medidasYChapa1000.push(2410,2600,2990)
        medidasYChapa1200.push(1565, 1665, 2490, 2850, 2990)
    }
       ...
       var calculoPeca3 = Math.round(calcDivisaoPeca(medidasXChapa[1],peca1.medidaXPeca)-0.5) * Math.round(calcDivisaoPeca(medidasYChapa1200[i], peca1.medidaYPeca)-0.5)
       var calculoPeca4 = Math.round(calcDivisaoPeca(medidasXChapa[1],peca1.medidaYPeca )-0.5) * Math.round(calcDivisaoPeca(medidasYChapa1200[i],peca1.medidaXPeca)-0.5)
        var resultado1PecaHorizontal = `A seguinte chapa : ${medidasXChapa[0]} X ${medidasYChapa1000[i]} com peça na horizontal cabem o total de : ${calculoPeca1} Peças`
        var resultado1PecaVertical = `A seguinte chapa : ${medidasXChapa[0]} X ${medidasYChapa1000[i]} com peça na vertical cabem o total de : ${calculoPeca2} Peças`
        var resultado2PecaHorizontal= `A seguinte chapa : ${medidasXChapa[1]} X ${medidasYChapa1200[i]} com peça na horizontal cabem o total de : ${calculoPeca3} Peças` 
        var resultado2PecaVertical = `A seguinte chapa : ${medidasXChapa[1]} X ${medidasYChapa1200[i]} com peça na horizontal cabem o total de : ${calculoPeca4} Peças`
        console.log(resultado2PecaHorizontal)
    }
